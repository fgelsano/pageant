                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="active"><a href="settings.php">Judges Record</a></li>
                              <li><a href="resultsrecord.php">Results Record</a></li>
                            </ul>
                            <div class="table-responsive">
                                <a class="btn btn-info" href="php/clearall.php?logs=0">Clear All Data</a>
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php 
                                        $data = $con->query("SELECT * FROM tbllogs ORDER BY record DESC");
                                        if($data->num_rows > 0){
                                            $x = 1;
                                            while($d_row = $data->fetch_assoc()){ ?>
                                                <tr>
                                                    
                                                    <td><?php echo $d_row['Judges']; ?></td>
                                                    <td><?php echo $d_row['cat']; ?></td>
                                                    <td><?php echo $d_row['crit']; ?></td>
                                                    <td><?php echo $d_row['Candidate']; ?></td>
                                                    <td><?php echo $d_row['Region']; ?></td>
