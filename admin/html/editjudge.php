        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php 
                    ...
                    if(!empty($_GET)){
                        $rec = $_GET['judgerec'];
                        $data = $con->query("SELECT * FROM tbljudges WHERE record = '$rec'")->fetch_assoc();
                    }else{
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            ...
                            <img style = "max-width:350px"width="100%" alt="user" src="../../Judging/images/user.png">
                        </div>
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input required name = "user" value = "<?php echo $data['username'];?>"type="text"  class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Password:</label>
                                    <div class="col-md-12">
                                        <input required name = "pass" value = "<?php echo $data['password'];?>"type="password"  class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
